					...
					<div class="my-1 px-1 w-full md:w-1/2 lg:my-4 lg:px-4 lg:w-1/3">
						...
						<article class="overflow-hidden rounded-lg shadow-lg bg-blue-50">
							...
							<a href="{{ route('emandate.dashboard') }}">
								<img alt="Placeholder" class="block h-auto w-full" src="https://www.fusebill.com/hs-fs/hubfs/FuseBill%20July-%202018/Simplify-Complex-Recurring-Billing.png?width=620&name=Simplify-Complex-Recurring-Billing.png">
							</a>
