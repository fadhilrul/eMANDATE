            ...
            <li class="relative px-6 py-3">
              ...
              >
                <span class="inline-flex items-center">
                  ...
                  <span class="ml-4">e-MANDATE</span>
                </span>
                <svg
                  class="w-4 h-4"
                  aria-hidden="true"
              ...
              <template x-if="isPagesMenuOpen">
                ...
                >
                  ...
                  <li
                    class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                  >
                    <a class="w-full" href="{{ route('searchcft.index') }}">
                      CFT
                    </a>
                  </li>
                  <li
                    class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                  >
                    <a class="w-full" href="{{ route('search.index') }}">Carian</a>
                  </li>
                  <li
                    class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                  >
                  ...
                  @if (session('authenticatedUser')['branch_code'] == '0009')
                    <li
                      class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                    >
                      <a class="w-full" href="{{ route('fullcalander.index') }}">Tetapan Tarikh Arahan Pemotongan</a>
                    </li>
                  @endif
                </ul>  
              </template>
          ...
          <ul>
            ...
            <li class="relative px-6 py-3">
              ...
              >
                ...
                <span class="ml-4">Rujukan Kod</span>
              </a>
            </li>
            <li class="relative px-6 py-3">
              <a
              ...
              >
                ...
                <span class="ml-4">Tetapan Tarikh Arahan Pemotongan</span>
              </a>
            </li>
        ...
        <header class="z-10 py-4 bg-white dark:bg-gray-800">
          ...
          >
            ...
            <ul class="flex items-center flex-shrink-0 space-x-6">
              ...
              <li class="relative">
                <button
                  class="align-middle rounded-full focus:shadow-outline-purple focus:outline-none inline-flex items-center gap-2"
                ...
                >
                  ...
                  {{ session()->get('authenticatedUser')['userid'] }}
