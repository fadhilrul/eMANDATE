...
<div class="container px-6 mx-auto grid">
    ...
    <div class="main-content flex-1 bg-gray-100 mt-12 md:mt-2 pb-24 md:pb-5">
      ...
      <div class="bg-blue-800 p-2 shadow text-xl text-white">
          <h3 class="font-bold pl-2">Bilangan Permohonan Daftar Mengikut Negeri</h3>
      </div>
                        ...
                        <div class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
                              ...
                              <div class="flex flex-row items-center">
                                    <div class="flex-1 text-right md:text-left">
                                          ...
                                          <h3 class="font-bold text-2xl"> {{($daftarJhr->count())}} 
                                    </div>
                              </div>      
                        </div>
                  </div>
                        ...
                        <div class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
                              ...
                              <div class="flex flex-row items-center">
                                    <div class="flex-1 text-right md:text-left">
                                          ...
                                          <h3 class="font-bold text-2xl"> {{($daftarKdh->count())}} 
                                    </div>
                              </div>      
                        </div>
                  </div>
                        ...
                        <div class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
                              ...
                              <div class="flex flex-row items-center">
                                    <div class="flex-1 text-right md:text-left">
                                          ...
                                          <h3 class="font-bold text-2xl"> {{($daftarKltn->count())}} 
                                    </div>
                              </div>      
                        </div>
                  </div>
                        ...
                        <div class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
                              ...
                              <div class="flex flex-row items-center">
                                    <div class="flex-1 text-right md:text-left">
                                          ...
                                          <h3 class="font-bold text-2xl"> {{($daftarMlk->count())}} 
                                    </div>
                              </div>      
                        </div>
                  </div>
                        ...
                        <div class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
                              ...
                              <div class="flex flex-row items-center">
                                    <div class="flex-1 text-right md:text-left">
                                          ...
                                          <h3 class="font-bold text-2xl"> {{($daftarN9->count())}} 
                                    </div>
                              </div>      
                        </div>
                  </div>
                        ...
                        <div class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
                              ...
                              <div class="flex flex-row items-center">
                                    <div class="flex-1 text-right md:text-left">
                                          ...
                                          <h3 class="font-bold text-2xl"> {{($daftarPhg->count())}} 
                                    </div>
                              </div>      
                        </div>
                  </div>
                        ...
                        <div class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
                              ...
                              <div class="flex flex-row items-center">
                                    <div class="flex-1 text-right md:text-left">
                                          ...
                                          <h3 class="font-bold text-2xl"> {{($daftarPrk->count())}} 
                                    </div>
                              </div>      
                        </div>
                  </div>
                        ...
                        <div class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
                              ...
                              <div class="flex flex-row items-center">
                                    <div class="flex-1 text-right md:text-left">
                                          ...
                                          <h3 class="font-bold text-2xl"> {{($daftarPrls->count())}} 
                                    </div>
                              </div>      
                        </div>
                  </div>
                        ...
                        <div class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
                              ...
                              <div class="flex flex-row items-center">
                                    <div class="flex-1 text-right md:text-left">
                                          ...
                                          <h3 class="font-bold text-2xl"> {{($daftarPP->count())}} 
                                    </div>
                              </div>      
                        </div>
                  </div>
                        ...
                        <div class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
                              ...
                              <div class="flex flex-row items-center">
                                    <div class="flex-1 text-right md:text-left">
                                          ...
                                          <h3 class="font-bold text-2xl"> {{($daftarSbh->count())}} 
                                    </div>
                              </div>      
                        </div>
                  </div>
                        ...
                        <div class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
                              ...
                              <div class="flex flex-row items-center">
                                    <div class="flex-1 text-right md:text-left">
                                          ...
                                          <h3 class="font-bold text-2xl"> {{($daftarSrwk->count())}} 
                                    </div>
                              </div>      
                        </div>
                  </div>
                        ...
                        <div class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
                              ...
                              <div class="flex flex-row items-center">
                                    <div class="flex-1 text-right md:text-left">
                                          ...
                                          <h3 class="font-bold text-2xl"> {{($daftarSlngr->count())}} 
                                    </div>
                              </div>      
                        </div>
                  </div>
                        ...
                        <div class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
                              ...
                              <div class="flex flex-row items-center">
                                    <div class="flex-1 text-right md:text-left">
                                          ...
                                          <h3 class="font-bold text-2xl"> {{($daftarTrg->count())}} 
                                    </div>
                              </div>      
                        </div>
                  </div>
                        ...
                        <div class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
                              ...
                              <div class="flex flex-row items-center">
                                    <div class="flex-1 text-right md:text-left">
                                          ...
                                          <h3 class="font-bold text-2xl"> {{($daftarKl->count())}} 
                                    </div>
                              </div>      
                        </div>
                  </div>
