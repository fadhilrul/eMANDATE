<main class="h-full pb-16 overflow-y-auto">
    <div class="container px-6 mx-auto grid">
      <div class="main-content flex-1 bg-gray-100 mt-12 md:mt-2 pb-24 md:pb-5">
          ...
          <div class="bg-blue-800 p-2 shadow text-xl text-white">
              <h3 class="font-bold pl-2">Senarai Maklumat Laporan Sekatan Pemotongan</h3>
          </div>
                ...
                <div class="align-middle inline-block min-w-full shadow overflow-hidden bg-white shadow-dashboard px-8 pt-3 rounded-bl-lg rounded-br-lg">
                    ...
                    <table class="min-w-full">
                        <thead>
                            ...
                            <tr>
                                <th class="px-6 py-3 border-b-2 border-gray-300 text-left leading-4 text-blue-500 tracking-wider">Tarikh Sekatan Pemotongan</th>
                                <th class="px-6 py-3 border-b-2 border-gray-300 text-left leading-4 text-blue-500 tracking-wider">Tarikh Terakhir Pemotongan Berjaya</th>
                                ...
                                <th class="px-6 py-3 border-b-2 border-gray-300 text-left leading-4 text-blue-500 tracking-wider">Sekatan Oleh</th>
                            </tr>
                        </thead>
    ...
    <a href= '{{ url("main-holdall-report") }}' >
